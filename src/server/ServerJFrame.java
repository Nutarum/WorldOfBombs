...
//Do NOT modify this code.
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ConnectionManager.getInstance().startGame();   
        jButton1.setEnabled(false);        
    }//GEN-LAST:event_jButton1ActionPerformed

    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        /* 
        if( jTextField1.getText().equals("START")){        
             jTextField1.setText("");  
              GameThread t = new GameThread();
              t.start();
        }else{*/
            ChatMessage msg = new ChatMessage("SERVER","", jTextField1.getText());
            jTextField1.setText("");  
            server.serverListener.sendGlobalMessage(msg);
       // }
